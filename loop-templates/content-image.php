...
$bgImgFull = $args['styling']['background_image'] ? 'style="background-image: url('.$args['styling']['background_image'].');height: 720px;"' : '';
...
<section class="template-with-background-image" >
    <div class="image-template" <?php echo $bgImgFull; ?>>
